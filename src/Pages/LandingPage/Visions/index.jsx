...
export default function Visions() {
  ...
  return (
    ...
    viewport={{ once: true }}
    transition={{ duration: 0.6 }} className="bg-purple-900 mx-auto max-w-[80rem] text-white p-4 md:p-8 lg:p-12">
      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        {services.map((service) => (
          ...
          >
            <div className={`w-full md:w-1/2 ${service.position === 'left' ? 'md:pr-8 lg:pr-16' : 'md:pl-8 lg:pl-16'} order-2 md:order-none`}>
            ...
            <div className={`flex flex-col items-center order-1 md:order-none mb-4 md:mb-0 ${service.position === 'left' ? 'md:absolute md:left-1/2' : 'md:absolute md:left-1/2'} md:transform md:-translate-x-1/2 md:top-1/2 md:-translate-y-1/2`}>
