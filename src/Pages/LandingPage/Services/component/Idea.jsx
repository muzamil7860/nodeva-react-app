  ...
  return (
    <section className="relative from-blue-950 to-purple-900 flex flex-col lg:flex-row items-center px-6 mt-[50px] overflow-hidden ">
      <div className="w-full lg:w-[50%] ">
        ...
        <button
          className="mt-8 flex items-center justify-center gap-2  p-2 text-[clamp(14px,2vw,24px)] font-['Poppins'] font-bold text-white rounded-[40px] border border-transparent bg-gradient-to-r from-[#3D05DD] to-[#EFA4F2]  transition-all duration-400 ease-in-out whitespace-nowrap"
        >
          Get Started
          <img
            src={arrow}
