...
const Footer = () => {
  return (
    <footer className="w-full bg-black text-white font-['Plus_Jakarta_Sans'] py-10 px-5 md:px-20">
      <div className="flex flex-col md:flex-row md:justify-between gap-10">
        ...
        <div className="flex-1 w-full sm:max-w-[400px]">
          ...
          <img src={Footerimg} className="w-full sm:w-[300px]" alt="Newsletter Input" />
        </div>
        ...
        <div className="flex-1 w-full sm:max-w-[300px]">
          ...
          <ul className="flex sm:block justify-between">
            <li>
              <a href="/terms-of-service" className="hover:text-[#8A38EE] font-['Poppins'] text-[16px]">
                Terms of Service
              </a>
            </li>
            <li>
              <a href="/privacy-policy" className="hover:text-[#8A38EE] font-['Poppins'] text-[16px]">
                Privacy Policy
              </a>
            </li>
            <li>
              <a href="/contact-us" className="hover:text-[#8A38EE] font-['Poppins'] text-[16px]">
                Contact Us
              </a>
            </li>
          </ul>
        ...
        <div className="flex-1 max-w-[300px]">
          <h3 className="text-xl font-semibold mb-4 font-['Poppins']">Contact Information</h3>
        ...
        <div className="flex-1 w-full sm:max-w-[300px]">
          ...
          <div className="flex justify-center md:justify-start gap-4">
            ...
            <img src={media_2} alt="Media 2" className="w-8 h-8 object-contain" />
          </div>
        </div>
      </div>
